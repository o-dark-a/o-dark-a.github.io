...
$(function(){$(".drop-down-contacts").hide(),$(".item_2").click(function(){return $(".drop-down-contacts").slideToggle("slow"),!1}),$(".my-top-mob-menu").hide(),$(".wrap-caption").click(function(){return $(".my-top-mob-menu").slideToggle("slow"),!1});var e=!0;function i(){window.matchMedia("screen and (max-width: 992px)").matches?$(".butt-more-info").show():window.matchMedia("screen and (min-width: 992px)").matches&&($(".butt-more-info").hide(),$(".wrap-more-info").mouseover(function(){$(this).find(".butt-more-info").show()}),$(".wrap-more-info").mouseout(function(){$(this).find(".butt-more-info").hide()}))}$(".inner-icon").click(function(){e?($(this).find(".fa-play-circle").addClass("hidden"),$(this).find(".fa-pause").removeClass("hidden"),$(".external-circle, .interior-circle").addClass("animated pulse"),document.getElementById("player").play()):($(this).find(".fa-pause").addClass("hidden"),$(this).find(".fa-play-circle").removeClass("hidden"),$(".external-circle, .interior-circle").removeClass("animated pulse"),document.getElementById("player").pause()),e=!e}),$(".more-info-sale-prod").hide(),$(".butt-sale").click(function(){$(".wrap-items-sale").hide(),$(".more-info-sale-prod").slideToggle("slow"),document.querySelector(".more-info-sale-prod").scrollIntoView()}),$(".onclick-like").hide(),$(".butt-subscribe").click(function(){$(".answer-you-like").hide(),$(".onclick-like").slideToggle("slow")}),$(".butt-more-info").click(function(e){e.preventDefault();var i=$(this).parent().siblings(".desc-block").parent().siblings(".more-info-about-prod").find(".more-info-prod").height();$(this).parents(".visible-collection").parents(".new-prod-carousel").height(i);var o=$(this).parent().siblings(".desc-block").find(".prod-name .h5").text(),t=$(this).parent().siblings(".desc-block").find(".prod-price").text(),n=$(this).parent().siblings(".img-block").find(".prod-img").css("background-image");$(this).parents(".item-1").next(".more-info-about-prod").find(".name-price-block .block-name h3").html(o),$(this).parents(".item-1").next(".more-info-about-prod").find(".block-price .block-price-new p").html(t),$(this).parents(".item-1").next(".more-info-about-prod").css("transform","translateY(0%)"),$(this).parents(".item-1").next(".more-info-about-prod").find(".product-characteristics-block .main-img").css("background-image",n)}),$(".more-info-prod-close").click(function(e){e.preventDefault(),$(this).parents(".more-info-about-prod").css("transform","translateY(-100%)"),$(this).parents(".visible-collection").parents(".new-prod-carousel").height("auto")}),$(".new-prod-carousel").owlCarousel({loop:!0,smartSpeed:700,items:1,nav:!0,dots:!0,navText:['<i class="fas fa-long-arrow-alt-left"></i>','<i class="fas fa-long-arrow-alt-right"></i>'],autoHeight:!0}),$(".ajax-form-buy-prod-butt").click(function(e){e.preventDefault()}),$(".button-buy").click(function(e){e.preventDefault();var i=$(this).parent().siblings(".prod-name").find(".h5").text(),o=$(this).parent().siblings(".prod-price").text(),t=$(this).parents(".desc-block").siblings(".img-block").find(".prod-img").css("background-image");$(".popup-buy-prod .img-product").css("background-image",t),$(".popup-buy-prod .name-product").html(i),$(".popup-buy-prod .price-product").html("<span>К оплате:</span> "+o)}),$(".button-buy").magnificPopup({removalDelay:400}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".my-footer-menu a, .my-top-mob-menu a, .my-top-menu a").mPageScroll2id(),$(window).resize(function(){i()}),$(document).ready(function(){i()})});